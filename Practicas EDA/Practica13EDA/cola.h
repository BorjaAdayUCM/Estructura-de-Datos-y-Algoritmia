...
public:
	...
	**/
	...
	/**
	COMPLEJIDAD: Lineal O(n), pues se recorre la cola una unica vez desde el nodo inicial
	hasta el nodo anterior al que queremos desplazar en un for.
	**/
