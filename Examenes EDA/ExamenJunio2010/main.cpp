#include <iostream>
#include "ConferenciaHidrografica.h"
#include <string>
#include "Pantano.h"
#include "Rio.h"
...
void creaRio(ConferenciaHidrografica& conferencia) {
	string nombreRio;
...
void crearPantano(ConferenciaHidrografica& conferencia) {
...
void embalsarPantano(ConferenciaHidrografica& conferencia) {
	string nombreRio, nombrePantano;
	float vol;
	cout << "Introduce el nombre del rio: ";
	cin >> nombreRio;
...
void embalsadoEnPantano(ConferenciaHidrografica& conferencia) {
	string nombreRio, nombrePantano;
	cout << "Introduce el nombre del rio: ";
	cin >> nombreRio;
	cout << "Introduce el nombre del pantano: ";
...
void embalsadoEnRio(ConferenciaHidrografica& conferencia) {
	string nombreRio, nombrePantano;
	cout << "Introduce el nombre del rio: ";
	cin >> nombreRio;
...
void transvasar(ConferenciaHidrografica& conferencia) {
...
void mostrar(ConferenciaHidrografica& conferencia) {
	conferencia.mostrar();
}

int main() {
	ConferenciaHidrografica conferencia = ConferenciaHidrografica();
	int op = menu();	
	while (op != 0) {
		switch (op) {
